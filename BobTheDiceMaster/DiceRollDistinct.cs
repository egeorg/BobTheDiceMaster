...
namespace BobTheDiceMaster
{
  ...
  public class DiceRollDistinct : IDiceRoll<DiceRollDistinct>
  {
    ...
    /// </exception>
    public DiceRollDistinct Reroll(int[] diceIndexesToReroll, IDie die)
    {
    ...
    /// </exception>
    public DiceRollDistinct ApplyReroll(int[] diceIndexesToReroll, DiceRollDistinct rerollResult)
    {
      int[] diceNew = (int[])dice.Clone();
